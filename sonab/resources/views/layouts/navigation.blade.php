        ...
        <div class="flex justify-between h-16">
            <div class="flex ">
                ...
                <div class="hidden space-x-8  sm:-my-px sm:ml-10 sm:flex ">
                    ...
                    <x-nav-link :href="route('A-propos.index')" :active="request()->routeIs('A-propos.index')">
                        {{ __('Qui sommes nous?') }}
                    </x-nav-link>

                    <x-nav-link :href="route('realisation.index')" :active="request()->routeIs('realisation.index')">
                        {{ __('Nos réalisations') }}
                    </x-nav-link>
                            ...
                            <div class="hidden space-x-8  sm:-my-px sm:ml-10 sm:flex ">
                                ...
                                @if (Route::has('login'))
                                        ...
                                        <x-nav-link :href="route('login')" :active="request()->routeIs('Se connecter')">
                                            ...
                                            <x-nav-link :href="route('register')" :active="request()->routeIs('Créer un compte')">
                                                {{ __('Créer un compte') }}
                                            </x-nav-link>
                                            @endif
                                        @endauth
